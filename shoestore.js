...
image.addEventListener("click", display3)
 ...
 let carts = document.querySelectorAll('.btn');
    ...
    function onloadCartNumbers() {
        ...
        if(productNumbers) {
            document.querySelector('.cartoveralimage span').textContent =productNumbers;
        }
    }
    ...
    function cartNumbers(product){
        ...
        if(productNumbers){
            ...
            document.querySelector('.cartoveralimage span').textContent= productNumbers + 1; 
        }else{
            localStorage.setItem('cartNumbers',1);
            document.querySelector('.cartoveralimage span').textContent= 1;
        }
        setItems(product);
    } 
    ...
    function displayCart() {
        ...
        if(cartItems && productContainer) {
            ...
            Object.values(cartItems).map(item => {
                ...
                `
                <div class='product1'>
                        <input type="button" id="dltbtn" value="Dlt" class="dltbtn" onclick="deletefromcart()">
    ...
    function deletefromcart(){
        ...
        document.getElementsById('total').classList.remove
    }
